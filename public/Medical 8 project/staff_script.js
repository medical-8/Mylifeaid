...
const idInput = document.getElementById('login-staff-id'); // updated to the new id
...
if (userBtn) { // only bind if the button actually exists on the page so it doesn't crash
    userBtn.onclick = () => {
...
/* ================================================= */
// added check so this doesn't crash if nextBtn isn't on the page
if (nextBtn) {
    nextBtn.onclick = () => {
